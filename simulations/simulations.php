  ...
  <div id="sidebarContainer">
    ...
    <div id="navcontainer">
      ...
      <ul>
        ...
        <li><a href="simulations.php"
           rel="self"
           id="current">Simulations</a></li>
...
<?php
	include "valueSignals.php";
//	include "signalPortfolio.php";
?>
    ...
    <div id="breadcrumbcontainer">
      ...
      <ul>
        ...
        <li><a href=
        "simulations.php">Simulations</a>&nbsp;/&nbsp;</li>
      </ul>
    </div><!-- End breadcrumb -->
